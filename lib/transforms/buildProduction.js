...
module.exports = function (options) {
    ...
    return function buildProduction(assetGraph, cb) {
        ...
        if (!assetGraph.followRelations) {
            var excludeRelationTypes = ['JavaScriptInclude', 'JavaScriptExtJsRequire', 'JavaScriptCommonJsRequire', 'SvgAnchor'];
        ...
        assetGraph
            ...
            .if(options.sourceMaps)
                .serializeSourceMaps()
                .updateRelations({ type: 'SourceMapSource' }, { hrefType: 'relative' })
            .endif()
            .if(options.gzip)
